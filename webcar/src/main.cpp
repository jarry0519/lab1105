...
<h2 style="text-align: center;">WiFi Controller</h2>
  <table id="mainTable" border="1" style="width:400px; margin:auto; table-layout:fixed; text-align: center;" CELLSPACING=10>
    ...
    <tr> </tr>
    <tr>
      <td style="text-align:center;font-size:24px"><b>Speed:</b>
      </td>
      <td colspan=2>
...
function initCarInputWebSocket()
{
 ...
 WebSocketCarInput.onopen = function(event)
 {
  ...
  WebSocketCarInput.onclose = function(event){setTimeout(initCarInputWebScoket, 2000)};
  WebSocketCarInput.onmessage = function(event){};
  
}

window.onload=initCarInputWebSocket;
document.getElementById("mainTable").addEventListener("touchend", function(enevt)
{
  event.prentDefault()
});
  </script>
